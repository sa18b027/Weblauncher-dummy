<template>
    <form class="add-favorite-modal" v-show="showAddFavoritesModal" @submit.prevent="onSubmit">
        <div class="input">
...
export default {
    ...
    methods: {
        ...
        onClickOk() {
            ...
            this.$store.commit('addFavorite', {name : this.name, url : this.url});
            /*this.addFavorite({
                name: this.name,
                url: this.url
            })*/
